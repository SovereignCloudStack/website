...
Darüber hinaus beteiligt sich das SCS Projekt im Rahmen des "Important Project of Common European Interest - Cloud Infrastrcture" aktiv im sogenannten GREEN-CIS Konsortium, kurz für "General Purpose Resilient and Secure Energy Efficient Computing InfrastructureNetwork". Dieses wachsende Bündnis aus insgesamt 28 Industrie- und Forschungspartnern hat sich zum Ziel gesetzt ein virtuelles, nachhaltiges, und als Einheit operierendes Cloud-Edge-System auf der Grundlage eines dezentralen, multi-provider Ökosystems zu entwickeln und aufzubauen. Hierbei freuen wir uns über das positive Feedback des Bundesministerium für Wirtschaft und Energie, welches den GREEN-CIS Zusammenschluss mit anderen in die europäische Koordinierung sendet.
