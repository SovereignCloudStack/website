...
The Sovereign Cloud Stack, funded by the [German Federal Ministry for Economic Affairs
and Climate Action](https://www.bmwi.de/Navigation/EN/Home/home.html) will be
released in its third version on March 23, 2022. Highlights of Release 2, to whose
success a community of over 20 companies contributed are update of all open source
components, the simplified provisioning of operating tools and Kubernetes clusters,
as well as the technical realization for connecting to the [Gaia-X Federation Services (GXFS)](https://www.gxfs.eu/).
...
number of companies and public IT service providers. In addition, two and soon three
...
also proves that the Sovereign Cloud Stack also meets the high security requirements
...
established cloud service providers to adapt their own offerings to the standard
developed by SCS.

The goal of Sovereign Cloud Stack is to develop an open-source-based toolkit for
sovereign, standardized cloud infrastructure. Companies can operate cloud services
across multiple SCS-compliant offerings. 

<blockquote><p>
Through open source, open standards, and
an open development process, Sovereign Cloud Stack makes an important contribution
to minimize lock-in effects in the cloud business, create freedom of choice and thus
...
API 1.0.x with support for Kubernetes 1.22 and 1.23.
...
that even setups with a high number of machines can be deployed with a manageable
operational effort.
...
independent selection of standard services. The configuration is maintained in a
git repository. 
...
been enhanced and cilium can now be used instead of calico as a network integration.
DevOps teams thus do not have to worry about integration of these components.

* The quality of our stack is constantly ensured by conformance tests
...
installations (Infrastrucutre-as-Code) without having to deal with a large number
of case distinctions for different cloud offerings.
...
cloud offerings. Two and soon three providers are already using SCS in production
