...
A more complete example can be found at [create\_vm.py](/assets/scripts/create_vm.py).
...
[trivial patch](/assets/scripts/openstackclient-diskless-boot.diff) fixes this:
```patch
