...
# SCS Product Owner Operations and Security (d/f/m)
...
* work closely with partners when they implement and operate SCS,
...
* work with the relevant open source communities, typically part of the CNCF, LF, OIF


 We expect that you

* have hands-on experience with open source toolinhg commonly used to help
	operators with life cycle management, updating, validating, monitoring,
	metering, logging, securing such environments.
* are experienced in the operational challenges for dynamic distributed
	infrastructure
* have had exposure to managing OpenStack and/or Kubernetes environments
